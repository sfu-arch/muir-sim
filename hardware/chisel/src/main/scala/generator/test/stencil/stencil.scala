...
class stencilDF(PtrsIn: Seq[Int] = List(64, 64), ValsIn: Seq[Int] = List(), Returns: Seq[Int] = List())
  ...
  val Loop_0 = Module(new LoopBlockNode(NumIns = List(1, 1, 2, 2, 1), NumOuts = List(), NumCarry = List(1, 1), NumExits = 1, ID = 0))
  ...
  val icmp_exitcond6531 = Module(new ComputeNode(NumOuts = 1, ID = 31, opCode = "eq")(sign = false, Debug = false))
  ...
  val icmp_39 = Module(new ComputeNode(NumOuts = 1, ID = 39, opCode = "slt")(sign = false, Debug = false))
  ...
  val icmp_exitcond54 = Module(new ComputeNode(NumOuts = 1, ID = 54, opCode = "eq")(sign = false, Debug = false))
  ...
  binaryOp_37.io.LeftIO <> Loop_0.io.OutLiveIn.elements("field2")(0)

  binaryOp_sub1042.io.LeftIO <> Loop_0.io.OutLiveIn.elements("field2")(1)

  ld_47.io.GepAddr <> Loop_0.io.OutLiveIn.elements("field3")(0)

  st_49.io.GepAddr <> Loop_0.io.OutLiveIn.elements("field3")(1)

  Gep_arrayidx45.io.baseAddress <> Loop_0.io.OutLiveIn.elements("field4")(0)
  ...
  Loop_0.io.CarryDepenIn(0) <> binaryOp_inc53.io.Out(0)

  Loop_0.io.CarryDepenIn(1) <> binaryOp_indvars_iv_next52.io.Out(0)
  ...
  phinc_06135.io.InData(1) <> Loop_0.io.CarryDepenOut.elements("field0")(0)

  phiindvars_iv34.io.InData(1) <> Loop_0.io.CarryDepenOut.elements("field1")(0)
  ...
  icmp_exitcond6531.io.enable <> bb_for_cond_cleanup729.io.Out(3)
  ...
  icmp_39.io.enable <> bb_for_body833.io.Out(8)
  ...
  icmp_exitcond54.io.enable <> bb_if_end2051.io.Out(5)
  ...
  icmp_exitcond6531.io.LeftIO <> binaryOp_inc2230.io.Out(1)

  br_32.io.CmpIO <> icmp_exitcond6531.io.Out(0)
  ...
  icmp_39.io.LeftIO <> binaryOp_38.io.Out(0)

  br_40.io.CmpIO <> icmp_39.io.Out(0)
  ...
  icmp_exitcond54.io.LeftIO <> binaryOp_indvars_iv_next52.io.Out(1)

  br_55.io.CmpIO <> icmp_exitcond54.io.Out(0)
