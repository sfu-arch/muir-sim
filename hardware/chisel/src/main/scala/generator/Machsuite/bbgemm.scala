...
class bbgemmDF(PtrsIn: Seq[Int] = List(32, 32, 32), ValsIn: Seq[Int] = List(), Returns: Seq[Int] = List())
  ...
  val binaryOp_6 = Module(new ComputeNode(NumOuts = 1, ID = 6, opCode = "shl")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))
  ...
  val binaryOp_9 = Module(new ComputeNode(NumOuts = 1, ID = 9, opCode = "add")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %2 = shl i64 %1, 4, !UID !17
  val binaryOp_10 = Module(new ComputeNode(NumOuts = 1, ID = 10, opCode = "shl")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %3 = add nuw nsw i64 %indvars.iv71, %indvars.iv82, !UID !18
  val binaryOp_11 = Module(new ComputeNode(NumOuts = 1, ID = 11, opCode = "add")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %4 = add nuw nsw i64 %3, %0, !UID !19
  val binaryOp_12 = Module(new ComputeNode(NumOuts = 1, ID = 12, opCode = "add")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))
  ...
  val binaryOp_17 = Module(new ComputeNode(NumOuts = 1, ID = 17, opCode = "add")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %7 = add nuw nsw i64 %6, %2, !UID !30
  val binaryOp_18 = Module(new ComputeNode(NumOuts = 1, ID = 18, opCode = "add")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))
