...
class fftDF(PtrsIn: Seq[Int] = List(32, 32, 32, 32), ValsIn: Seq[Int] = List(), Returns: Seq[Int] = List())
  ...
  val binaryOp_or7 = Module(new ComputeNode(NumOuts = 4, ID = 7, opCode = "or")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %xor = xor i32 %or, %span.0113, !UID !14
  val binaryOp_xor8 = Module(new ComputeNode(NumOuts = 2, ID = 8, opCode = "xor")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))
  ...
  val binaryOp_shl27 = Module(new ComputeNode(NumOuts = 1, ID = 27, opCode = "shl")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %and = and i32 %shl, 1023, !UID !38
  val binaryOp_and28 = Module(new ComputeNode(NumOuts = 2, ID = 28, opCode = "and")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))

  //  %tobool27 = icmp eq i32 %and, 0, !UID !39
  val icmp_tobool2729 = Module(new ComputeNode(NumOuts = 1, ID = 29, opCode = "eq")(sign = false, Debug = false, GuardVals=Seq.tabulate(1000)(n => n)))
