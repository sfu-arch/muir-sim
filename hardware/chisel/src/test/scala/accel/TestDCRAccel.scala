...
import dandelion.accel.{DandelionAccelDCRModule, DandelionAccelDebugModule, DandelionAccelModule, DandelionAccelReadDebugModule}
...
/**
  ...
  * @tparam T
  */
abstract class DandelionTestDebugStreamDCRAccel[T <: DandelionAccelDebugModule](implicit val p: Parameters)
  extends MultiIOModule with HasAccelShellParams

object DandelionTestDebugStreamDCRAccel {
  ...
  /**
    ...
    * @return
    */
  def apply(testName: String, numDbgs: Int, boreIDsList: Seq[Int])(implicit p: Parameters):
  (() => DandelionAccelDCRModule, () => DandelionAccelDebugModule, () => DandelionAccelReadDebugModule) = {
    testName match {
